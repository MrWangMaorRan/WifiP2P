...
import com.example.qrcode.add.AutoScannerView;
import com.example.qrcode.add.CameraManager;
...
public class ScannerActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onResume() {
        ...
        cameraManager.setManualFramingRect(mScanFocusWidth, mScanFocusHeight);
...
//        iv_xiangce = findViewById(R.id.iv_xiangce);
        iv_shanguangdeng = findViewById(R.id.iv_shanguangdeng);
//        iv_xiangce.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                //先申请权限
//                int checked = ContextCompat.checkSelfPermission(ScannerActivity.this
...
//        });
        ...
        iv_shanguangdeng.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (isKai) {
                    cameraManager.setTorch(false);
                    iv_shanguangdeng.setImageResource(R.drawable.icon_shanguangdeng_guan);
                    isKai = false;
                } else {
                    cameraManager.setTorch(true);
                    iv_shanguangdeng.setImageResource(R.drawable.icon_shanguangdeng);
                    isKai = true;
                }
            }
        });
